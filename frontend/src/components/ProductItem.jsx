    ...
    return (
        <div className="border rounded-lg p-4 shadow-sm hover:shadow-lg transition duration-300 relative w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg mx-auto bg-white">
            ...
            <div className="relative group rounded-lg overflow-hidden">
                ...
                {/* Wishlist & Quick View Icons (Initially Hidden) */}
            ...
            {/* Add to Cart Button */}
            <button className="bg-green-500 text-white font-semibold py-2 px-4 rounded-md mt-4 w-full hover:bg-green-600 transition">
                + Add
            </button>
        </div>
    );
